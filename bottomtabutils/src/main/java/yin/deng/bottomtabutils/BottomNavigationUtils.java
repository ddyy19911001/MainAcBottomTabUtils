...
public class BottomNavigationUtils {
    ...
    /**
     * BottomNavigationUtils.initNavigationBarNormalSetting().create();
     * 即可创建出对应的底部菜单栏，create()方法调用前，还可继续修改参数。
     * @param activity
     * @param navigationBar
     * @param tabText
     * @param normalIcon
    ...
    public  BottomNavigationUtils initNavigationBarNormalSetting(AppCompatActivity activity, EasyNavigationBar navigationBar, String[] tabText, int[] normalIcon, int[] selectIcon, List<Fragment> fragments){
        if(utils==null){
...
//                .addSelectTextColor(Color.parseColor("#00ff00"))    //加号文字选中时字体颜色
    ...
    public  void create(EasyNavigationBar navigationBar){
     ...
     * @param count
     */
    public  void setMessageCount(EasyNavigationBar navigationBar, int position, int count){
     ...
     * @param showHide
     */
    public  void setRundPointShowHide(EasyNavigationBar navigationBar, int position, boolean showHide){
        //红点提示 第二个参数控制是否显示
     ...
     * @param position
     */
    public  void clearMsgPoint(EasyNavigationBar navigationBar, int position){
        //清除第一个数字消息
     ...
     * @param position
     */
    public  void clearRundPoint(EasyNavigationBar navigationBar, int position){
        //清除第四个红点提示
